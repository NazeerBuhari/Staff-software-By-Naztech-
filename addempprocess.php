...
if(in_array($filecheck, $fileextstored)){
    ...
    $sql = "INSERT INTO `employee`(`firstname`, `lastname`, `branch`, `birthday`, `gender`, `contact`, `address`, `dept`, `position`, `pic`,`staff_id`,`employmentStatus`,`salary`,`remark`,`guarantor`)
                            VALUES ('$firstname','$lastname','$branch','$birthday','$gender','$contact','$address','$dept','$position','$destinationfile','$staff_id','$employmentStatus','$salary','$remark','$guarantor')";
